...
@section('content')
    <div class="card my-5">
        <img src="{{ $movies->image }}" class="card-image-top" width="200">
        <div class="card-body">
            <h1>{{ $movies->title }}</h1>
        <div class="text-danger">
            ...
            <ul class="list-group list-group-flush">
              ...
              <li class="list-group-item">
                ...
                @auth
                    <form action="{{ route('movie_cast_destroy', [$movies->id, $cast->id]) }}" method="post">
                        @csrf
                        @method('delete')
              ...
              <form action="{{ route('movies.comments.store', $movies->id) }}" method="POST">
                @csrf
        ...
        @endauth
        <a href="/movies" class="btn btn-link float-right">kembali ke halaman movies</a>
    </div>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="row">
              <div class="col-md-6">
                <h1>Cast Role</h1>
                <form action="{{ route('movie_cast_store', $movies->id) }}" method="POST">
                  @csrf
